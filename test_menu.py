...
def laodJouer():
    self.current_page = "jouer"
    print("jouer")

def laodHighscore():
    self.current_page = "highscore"
    print("highscore")
...
if current_page == "menu":
    ...
    jouer.setButtonAction(laodJouer)
    highscore.setButtonAction(laodHighscore)
    credit.setButtonAction(laodCredit)
